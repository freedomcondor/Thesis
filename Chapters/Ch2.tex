...
Swarm robotics follows this principle, aiming to create decentralized systems capable of scalability, adaptability, and fault-tolerance.
    \cite{dorigo2014swarm} \textcolor{red}{to read} % scholarpedia on swarm robotics
    \cite{dorigo2020reflections} \textcolor{red}{to read}
...
Such decentralized systems have shown advantages in applications that requires large scale and space such as
    Environmental monitoring \cite{talamali2021less} \textcolor{red}{varify, from Abstract, maybe not a good choice}, 
...
Although researches have been trying to create theoretical framwork
    ...
    \cite{hamann2010space} \textcolor{red}{to read}
    \cite{hamann2018swarm} \textcolor{red}{to read}
...
\textcolor{red}{re-consider these citations:}
%for Evaluation:
...
In pure flat (homogeneous) swarms, like its nature inspiraion
    \cite{buhl2006disorder}
    \cite{detrain2008collective}
    \cite{theraulaz1998origin}
,
...
\textcolor{blue}{What is hierarchical}
...
rigid body graph
\cite{yang2018growing} too mathematical
\cite{mehdifar2018finite} 

bearing
\cite{zhao2019bearing} more like a survey
...
\cite{li2021adaptive}
\cite{li2020bearing}
\cite{zhao2021finite} more general
\cite{zhang2022distributed}
\cite{zhang2023bearing} water
\cite{arrigoni2018bearing}
\cite{trinh2018bearing}
\cite{trinh2021finite}

bearing rigidity
\cite{tay1985generating} \textcolor{red}{consider drop}
...
\cite{kambayashi2018distributed} uses virtual agents has potential for interchangeable
