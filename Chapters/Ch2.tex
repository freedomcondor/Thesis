...
Purely decentralized swarms are highly scalable and fault tolerant but often are difficult to design and perform poorly in certain tasks, especially when global information is required.
Centralized systems, by contrast, are easy to design, achieve better performance due to its optimal coordination, but lose scalability and fault tolerance.
...
If makes them difficult to be detected and have negative influence to the swarm
    \cite{zhou2019review}
...
In despite of significant advances in individual robot autonomy and artificial cognition
...
they often suffer from slow convergence.

\cite{kolling2013human} \textcolor{red}{verify}

\textcolor{blue}{so, a gap}

In general, there lacks a framework that can issue commands to swarm robots in fast speed without sacrificing scalability.
