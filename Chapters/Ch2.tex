...
% indivudal autonomy is good, but swarm autonomy is a challenge
...
Collective decision making is a classical task for swarm systems for environmental analysis.
...
As swarm systems scale up, it becomes impractical for a human operator to interact with individual robots.
Existing surveys
    \cite{siean2023opportunities,
          kolling2015human}
classify the main interface modalities and control strategies for human–swarm interaction (HSI).
...
Designing controllers for swarm systems is often a long trial-and-error process
    \cite{hamann2018swarm,
          brambilla2013swarm}.  
