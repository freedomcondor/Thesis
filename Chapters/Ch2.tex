...
The goal of sensor dispersion approaches is to spread sensors over the environment to cover the target area,
...
In these approaches, although sensor localization may rely on GPS or range-based measurements, the interactions among the robots are typically decentralized.
...
In another family of approaches, robots sweep the environment in parallel.
...
Given the emphasis of swarm robotics on scalability and fault tolerance, we focus on decentralized formation control, which is the focus of the majority of existing work from a control-theoretic perspective.
...
...
This goal is particularly challenging for swarm systems, since robots operate with only local information, hindering consensus in decision making, 
