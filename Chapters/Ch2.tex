...
%
To summarize, while random exploration is robust and scalable, it often suffer from long completion times and inefficient coverage.
...
However, studies in over-the-air program updating for robot swarms also highlights fundamental limitations such as slow propagation resulting from consensus mechanisms
    \cite{de2009energy,
...
Swarm systems shows some degree of inherent fault tolerance because of their redundancy and absence of single points of failure
