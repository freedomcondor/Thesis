...
\cite{bonabeau1999swarm} book
\cite{floreano2008bio} book
\cite{csahin2004swarm}
\cite{beni1988concept} cellular robotic system
...
\cite{valentini2016collective} : more communicative \textcolor{red}{how?}
\cite{balazs2020adaptive} : more persistent

with leaders:
\cite{gu2009leader} flocking leader, not formation
\cite{amraii2014explicit} leader in flocking, not formation
\cite{zheng2020adversarial} tries to detect and hind the leader
